    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form ng-submit="updateUser()" id="formUserUpdate" name="formUserUpdate">
                    <div class="row">
                        <div class="col-12">
                        ...
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
                            ...
                            <input ng-model="userActive.password" name="password" type="password" class="form-control" minlength="2" maxlength="45" ng-model="registerRoleName">
                        </div>
                        <div class="col-12 col-md-6 col-xl-4 mb-3">
            ...
            <div class="modal-footer">
                ...
                <button type="submit" form="formUserUpdate" class="btn btn-primary">Guardar cambios</button>
            </div>
        </div>
    </div>
</div>