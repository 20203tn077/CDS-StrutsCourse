...
<head>
    ...
    <script src="<s:property value="#path"/>/js/modules/role/role.js"></script>
</head>
<body ng-controller="role">
<%--Navbar--%>
                        ...
                        <div class="col">
                            <table class="table">
                                ...
                                <tr ng-repeat="role in roles" class="text-center">
                                    ...
                                    <td class="align-middle">
                                        <button class="btn btn-info" ng-click="showDetails(role.id)"><i data-feather="info-circle"></i>&nbsp;Detalles</button>
                                        <button class="btn btn-primary" ng-click="showUpdate(role.id)" ng-disabled="role.status.id === 2"><i data-feather="edit"></i>&nbsp;Modificar</button>
                                        <button class="btn btn-danger" ng-click="showDelete(role.id)" ng-disabled="role.status.id === 2"><i data-feather="trash-2"></i>&nbsp;Eliminar</button>
                                    </td>
                                </tr>
                                </tbody>
                            </table>
...
<%--Modal registro--%>
<jsp:include page="/components/role/modalRegister.jsp"></jsp:include>
<%--Modal modificación--%>
